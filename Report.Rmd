...
words to give a possibility to choice the right one by user itself. The
goal of this application is to reduce the amount of typing, because it might be not
very convenient when using mobile devices. So giving 5 most probable next words to
